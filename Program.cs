                ...
                Console.WriteLine("{0,-5} {1,-20} {2,-20} {3,-20} {4,-20} {5,-10} {6,-35} {7,-10} {8,-10}", "No", "Matricule", "Name", "Surname", "Nationality", "Record", "Birthday", "Height", "Old");
                 ...
                 int selected_male=0;
                    ...
                    */
                    ...
                    if(Nationality_verifictor(Alpha.nationality)==1){// if the appl,cant have türk nationality
                        if(Old_verificator(Alpha.old)==1){//if he or she are 16 years old
                            if(Height_verificator(Alpha.height)==1){//if he or she are minimum height 170 cm 
                                if(Record_detention_verificator(Alpha.record)==1){//if applicant have or not criminal or drug traffic record.
                                    PreListWriter.WriteLine("{0,-5} {1,-20} {2,-20} {3,-20} {4,-20} {5,-10} {6,-35} {7,-10} {8,-10} {9,-10} {10,-10} {11,-10} {12,-10} {13,-10}",Number2,Alpha.matricule,Alpha.name,Alpha.surname,Alpha.nationality.ToUpper(),Alpha.record.ToUpper(),Alpha.birthday,Alpha.gender,Alpha.height,Alpha.old ,Alpha.bedNot,Alpha.precision_shooting,Alpha.psycoTest,Alpha.moy);
                                    ...
                                    if(Alpha.moy>=60){// This is the simple example for selection average.if the applicant average is equal or bigger than 60 ,he or she will be selected.
                                        FinalListWriter.WriteLine("{0,-5} {1,-20} {2,-20} {3,-20} {4,-20} {5,-10} {6,-35} {7,-10} {8,-10} {9,-10} {10,-10} {11,-10} {12,-10} {13,-10}",Number1,Alpha.matricule,Alpha.name,Alpha.surname,Alpha.nationality.ToUpper(),Alpha.record.ToUpper(),Alpha.birthday,Alpha.gender,Alpha.height,Alpha.old ,Alpha.bedNot,Alpha.precision_shooting,Alpha.psycoTest,Alpha.moy);
                                        Console.WriteLine("{0,-5} {1,-20} {2,-20} {3,-20} {4,-20} {5,-10} {6,-35} {7,-10} {8,-10} {9,-10} {10,-10} {11,-10} {12,-10} {13,-10}",Number1,Alpha.matricule,Alpha.name,Alpha.surname,Alpha.nationality.ToUpper(),Alpha.record.ToUpper(),Alpha.birthday,Alpha.gender,Alpha.height,Alpha.old ,Alpha.bedNot,Alpha.precision_shooting,Alpha.psycoTest,Alpha.moy);
